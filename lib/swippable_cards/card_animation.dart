...
class CardAnimation {
  ...
  CardAnimation({
    ...
    // Initialize all animations to safe defaults in the constructor body
    _leftAnimation = AlwaysStoppedAnimation(0);
    _topAnimation = AlwaysStoppedAnimation(0);
    _scaleAnimation = AlwaysStoppedAnimation(initialScale);
    _differenceAnimation = AlwaysStoppedAnimation(Offset.zero);
  }
